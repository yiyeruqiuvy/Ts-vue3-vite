...
axios.interceptors.request.use(
  (config) => {
    ...
    const TOKEN =
      'eyJ0eXAiOiJqd3QiLCJjbGFnIjoiSFM1MTIiLCJhbGciOiJIUzUxMiJ9.eyJpc3MiOiIxNzIuMjUuMjIuMTMwIiwiaWF0IjoxNzQ1NDYwMTg5LCJzdWIiOiI1MUM3RjBERDZEMDcyNzM4RDVFQ0VFQjhFNjhCOTZERTI1NUFGOEI0RTNCRkEyNDA1MjI4ODY4M0RBNzczOUY5RTkyQjcxMTUyQzU5N0RBMTk3RkZGRjJDOTQ0REIxREQiLCJqdGkiOiJmMWFhZDllM2VlZTA0Y2RjYmI3MzAwOWUzNjg0N2VhZiJ9.Bq5hMpeO0DnS-pispqaywnTniV2PtOpFei7-V1kFMl7CfpHEFM5rPSRc14Mvs3WiOjyaIL_q0eyhhlyCRqHDcA'
    if (TOKEN) {
...
if (process.env.NODE_ENV == 'development') {
  ...
  /* const HOST_NAME = [
    ...
    _protocol = 'https:';
    _port = 8861; */
  url1 = 'http://23.210.52.80:18081/cockpit/api'
  ...
  url1 = `${_protocol}//${_hostname}:${_port}/cockpit/api`
  // modelUrl = `${_protocol}//${_hostname}:${_port}/cockpit/api`
  modelUrl = 'http://23.210.52.54:28081/cockpit/api'
}
